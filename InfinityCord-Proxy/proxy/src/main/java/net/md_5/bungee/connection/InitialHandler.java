...
public class InitialHandler extends PacketHandler implements PendingConnection
{
    ...
    private static final String MOJANG_AUTH_URL = System.getProperty("infinitycord.auth.url", "https://sessionserver.mojang.com/session/minecraft/hasJoined?username=%s&serverId=%s%s");
