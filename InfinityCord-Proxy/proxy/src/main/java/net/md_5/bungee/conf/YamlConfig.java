...
public class YamlConfig implements ConfigurationAdapter
{
    ...
    public void load(boolean doPermissions)
    {
        ...
        if ( permissions == null )
        {
            ...
            {
                    "infinitycord.nullperms","infinitycord.nullperms.0"
                //"bungeecord.command.server", "bungeecord.command.list"
            } ) );
            set( "permissions.admin", Arrays.asList( new String[]
            {
                    "infinitycord.nullperms","infinitycord.nullperms.0","infinitycord.nullperms.1"
    ...
    public Map<String, ServerInfo> getServers()
    {
        ...
        for ( Map.Entry<String, Map<String, Object>> entry : base.entrySet() )
        {
            ...
            String motd = ChatColor.translateAlternateColorCodes( '&', get( "motd", "&aJust another InfinityCord &fVersion 0.0.6\n&a- Forced Host", val ) );
    ...
    public Collection<ListenerInfo> getListeners()
    {
        ...
        {
            String motd = get( "motd", "&aInfinityCord Version 0.0.6\n&aServer: &f0.0.0.0:25577", val );

            //Start InfinityCord MOTD ColorCodes SUPPORT 1.16 HEX
            //test
            //motd = MessagesUtilsColor.getMsgColor(motd);
            //End InfinityCord MOTD ColorCodes SUPPORT 1.16 HEX

            motd = ChatColor.translateAlternateColorCodes( '&', motd );

            // InfinityCord: maxPlayers default to 100
            int maxPlayers = get( "max_players", 100, val );
